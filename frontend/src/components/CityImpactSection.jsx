  ...
  return (
    <section className="flex flex-col w-full max-w-[1200px] mx-auto items-start gap-4 px-4 opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:0ms]">
      <header className="flex flex-wrap items-end gap-8 lg:gap-[115px] w-full opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:200ms]">
        <h1 className="flex items-end justify-center flex-1 min-w-[280px] font-samarkan font-normal text-[#111111] text-4xl md:text-5xl lg:text-[64px] tracking-[-4.48px] leading-tight lg:leading-[64px]">
        ...
        <p className="flex items-end justify-center ff-inter font-normal text-neutral-700 text-base md:text-lg lg:text-xl text-right tracking-[0] leading-relaxed lg:leading-[33px] whitespace-nowrap">
          <span className="ff-inter font-normal text-neutral-700 text-base md:text-lg lg:text-xl tracking-[0] leading-relaxed lg:leading-[33px]">
