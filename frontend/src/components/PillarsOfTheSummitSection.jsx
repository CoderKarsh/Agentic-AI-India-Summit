...
export const PillarsOfTheSummitSection = ({ className = "", ...props }) => {
  return (
    <section className={`flex flex-col w-full max-w-300 mx-auto items-start gap-[58px] px-4 py-8 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] ${className}`} {...props}>
