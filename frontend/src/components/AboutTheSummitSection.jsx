  ...
  return (
    <section className="flex flex-col w-full max-w-[1210px] mx-auto items-center gap-[65px] px-4 py-8 opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:0ms]">
      ...
      <div className="relative w-full max-w-[1210px] min-h-[198px]">
        <div className="inline-flex items-center justify-center gap-2.5 px-10 py-5 absolute top-[67px] left-[700px] bg-[#e88b58] rounded-[0px_140px_140px_0px] shadow-[inset_0px_4px_4px_#0000001a] opacity-0 animate-fade-in [--animation-delay:700ms]">
          <div className="relative w-fit ff-inter font-normal text-white text-xl text-right tracking-[0] leading-[normal] whitespace-nowrap">
        ...
        <div className="flex w-[362px] items-center justify-center gap-2.5 px-10 py-5 absolute top-0 left-[492px] bg-[#e88b58] rounded-[0px_140px_140px_0px] shadow-[inset_0px_4px_4px_#0000001a] opacity-0 animate-fade-in [--animation-delay:300ms]">
          <div className="relative w-fit ml-[-8.50px] mr-[-8.50px] text-white text-xl text-right tracking-[0] leading-[normal] whitespace-nowrap ff-inter font-normal">
        ...
        <div className="flex w-[514px] items-center justify-center gap-2.5 px-10 py-5 absolute top-0 left-1 bg-[#e35877] rounded-[140px] shadow-[inset_0px_4px_4px_#0000001a] opacity-0 animate-fade-in [--animation-delay:200ms]">
          <div className="relative w-fit ml-[-6.50px] mr-[-6.50px] text-white text-xl text-right tracking-[0] leading-[normal] whitespace-nowrap ff-inter font-normal">
